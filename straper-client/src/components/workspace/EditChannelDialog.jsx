...
const EditChannelDialog = ({ isOpen, close, channel }) => {
  const {
    register,
    handleSubmit,
    reset,
  ...
  const handleUpdate = (data) => {
    api.post("/protected/channel/update", data).then((res) => {
      if (res.data.Success) {
        updateChannel(data.channel_id, data.channel_name, channel.workspace_id);
        close();
      }
    });
  };
