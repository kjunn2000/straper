...
(36),
  `user_id` VARCHAR
(255),
  `last_accessed` DATETIME NOT NULL DEFAULT
(now
()),
  PRIMARY KEY
(`channel_id`, `user_id`)
...
ADD FOREIGN KEY
(`user_id`) REFERENCES `user_detail`
(`user_id`) ON
DELETE CASCADE;

ALTER TABLE `user_access_info`
ADD FOREIGN KEY
(`credential_id`) REFERENCES `user_credential`
(`credential_id`) ON
DELETE CASCADE;

ALTER TABLE `workspace`
ADD FOREIGN KEY
(`creator_id`) REFERENCES `user_detail`
(`user_id`) ON
DELETE CASCADE;

ALTER TABLE `verify_email_token`
ADD FOREIGN KEY
(`user_id`) REFERENCES `user_credential`
(`user_id`) ON
DELETE CASCADE;
...
ADD FOREIGN KEY
(`board_id`) REFERENCES `task_board`
(`board_id`) ON
DELETE CASCADE;
